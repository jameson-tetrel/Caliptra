...
* **Checklist Item:**
  * **Requirement:** SOC firmware that interacts with Caliptra as the privileged AXI\_USER (**note: PAUSER in v1.x**) MUST be measured, and those measurements MUST be submitted to Caliptra. Other SOC firmware SHOULD be measured. Configuration data that modifies the security properties of firmware MUST also be measured. 
